...
const { getAuthProfile, getProfile, updateProfile, deleteProfile, hireTalent, handleHireTalent } = require('../controller/profile')
const picturesUpload = upload.fields([
    { name: "profilePicture", maxCount: 1 },
    { name: "picturesOfWork", maxCount: 12 },
]);

router.route('talent/profile/me').get(authenticateTalent, getAuthProfile)
